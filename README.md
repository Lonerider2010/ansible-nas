...
The following lists, generated by [create_portlists.py](create_portlists.py), show the ports used by the applications above:

* [portlist_apps](portlist_apps.md) Portlist, sort by applications
* [portlist_ports](portlist_ports.md) Portlist, sort by port numbers
